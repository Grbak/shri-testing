...
export const ProductItem: React.FC<ProductItemProps> = ({ product }) => {
    return (
        <div data-testid={`product_card-${product.id}`} className={bem(null, ['card', 'w-100', 'mb-4'])}>
            ...
            <div className="card-body">
                ...
                <Link data-testid="link-product_detail" to={`/catalog/${product.id}`} className={bem('DetailsLink', ['card-link'])}>Details</Link>
